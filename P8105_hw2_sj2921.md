...
<!-- end list -->
  ...
  - After doing this, the data is basically readable, however, it’s not
    clean enough since there are routes spreaded in the dataframe.
...
1.  There are 404 distinct locations in the dataset; Every state is
    represented as 51 distinct values are included for states; NJ is
    observed most.
...
![](P8105_hw2_sj2921_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](P8105_hw2_sj2921_files/figure-gfm/unnamed-chunk-3-2.png)<!-- -->
