...
* After doing this, the data is basically readable, however, it's not clean enough since there are routes spreaded in the dataframe.
...
```
1. There are `r nrow(unique_lc)` distinct locations in the dataset; Every state is represented as 51 distinct values are included for states; NJ is observed most. 
2. In 2002, the median of the “Excellent” response value is `r med_excel`.
